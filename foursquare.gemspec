...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.rdoc", "Rakefile", "History", "lib/foursquare.rb", "spec/foursquare_spec.rb", "spec/spec_helper.rb", "script/destroy", "script/generate", "examples/fq_test_script.rb"]
  s.homepage = %q{http://jeremyrwelch.com}
  s.require_paths = ["lib"]
